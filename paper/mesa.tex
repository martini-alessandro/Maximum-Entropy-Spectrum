...
An ubiquitous method for such computation is due to Welch \cite{Welch} and it based on eqs.(\ref{eq:psd-autocorrelation}-\ref{eq:psd-f-definition}).
...
In analogy as what observed for the peak at $f_D$, in the CAT spectru we observe a higher order harmonic at a frequency $2 \cdot f_{yr}$. As in the previous case, this is required to better model the temperature variation in the year.
