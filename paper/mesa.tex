...
\begin{document}
	...
	Stefano \surname{Schmidt}\inst{\ref{inst2}}\thanks{s.schmidt@uu.nl} \and Gregory \surname{Ashton}\inst{\ref{inst1}}\thanks{walter.delpozzo@unipi.it} \and Walter \surname{Del Pozzo}\inst{\ref{inst1}}\thanks{walter.delpozzo@unipi.it}}
