...
In the first one (see fig.~\ref{fig:mem_welch_fakedata}), we simulate data from an analytical PSD and we make the comparison with them: this is to ensure the we have a baseline PSD to compare the data with.
...
\sschimidt{Is it fine to ackonowledge people helping with temperature data and seismic data?}
%S.S. wants to thank Maurizio Maugeri and Costanza Rossi for useful discussions.
