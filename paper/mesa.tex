...
\begin{document}
	...
	\author{Alessandro \surname{Martini}\inst{1,2,3}\thanks{alessandro.martini-1@unitn.it} \and 
	Stefano \surname{Schmidt}\inst{4,5}\thanks{s.schmidt@uu.nl} \and Gregory \surname{Ashton}\inst{6} \and Walter \surname{Del Pozzo}\inst{1}\thanks{walter.delpozzo@unipi.it}}
