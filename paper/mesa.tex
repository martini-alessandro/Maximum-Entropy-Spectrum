...
Our choice, the Tukey window with aforementioned parameters, is the best compromise with found between noise 
...
\subsection{Temperature Time Series} \label{sec:temp_timeseries}[review]
We apply our code to the study of the temperature time series. This will allow to test our model performance on an example of great importance in physics. We will also assess the quality of the forecasting predictions: this task has a great impact also on practical applications.
...
As a last example of an application of MESA on real data, we go back to the strain produced by the LIGO-Virgo interferometers and we forecast the future observations.
